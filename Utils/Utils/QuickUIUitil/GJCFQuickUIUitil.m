...
+ (void)animationView:(UIView *)view withAnimationPath:(NSString *)path toValue:(NSValue *)value withDuration:(NSTimeInterval)duration
{
    ...
    [view.layer addAnimation:basicAnimation forKey:[NSString stringWithFormat:@"gjcfAnimation_%@_%lu_%lu_%f",path,(unsigned long)[view hash],(unsigned long)[value hash],duration]];
}
